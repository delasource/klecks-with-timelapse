...
export class GestureListener {
  ...
  destroy(): void {
    this.onStart && this.target.removeEventListener('gesturestart', this.onStart as TGenericListener);
    this.onChange && this.target.removeEventListener('gesturechange', this.onChange as TGenericListener);
