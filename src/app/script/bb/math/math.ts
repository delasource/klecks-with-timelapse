...
export function snapAngleDeg(angleDeg: number, snapDegIncrement: number, maxDistDeg: number): number {
...
export function boundsOverlap(bounds: TBounds | undefined, limit: TBounds | undefined): TBounds | undefined {
  if (!bounds) {
    return undefined;
  }
  if (!limit) {
 ...
 */
export function boundsInArea(bounds: TBounds | undefined, width: number, height: number): TBounds | undefined {
  if (!bounds) {
    return undefined;
  }
