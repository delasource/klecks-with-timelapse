...
export class KlColorSlider {
  ...
  private updateSVCanvas(): void {
    ...
    this.svGradient.style.setProperty('--kl-color-picker--hue', '#' + BB.ColorConverter.toHexString(rgb));
  }
  ...
  private setColPreview(): void {
    this.divPreview.style.backgroundColor =
      'rgb(' + this.primaryColorRgb.r + ',' + this.primaryColorRgb.g + ',' + this.primaryColorRgb.b + ')';
