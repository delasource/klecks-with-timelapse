...
import { applyToPoint, compose, decomposeTSR, identity, Matrix, rotate, scale, translate } from 'transformation-matrix';
      ...
      draw: (ctx: CanvasRenderingContext2D) => {
        ...
        if (this.selectionSample && this.doClone) {
          if (this.selectionSample.image) {
            ...
            const canvasTransform = compose(transform, this.selectionSample.transformation);
