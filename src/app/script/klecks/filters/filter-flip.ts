...
import { TFilterApply, TFilterGetDialogParam, TFilterGetDialogResult, TKlBasicLayer, TMixMode } from '../kl-types';
...
export const filterFlip = {
  ...
  apply(params: TFilterApply<TFilterFlipInput>): boolean {
    ...
    klCanvas.flip(horizontal, vertical, flipCanvas ? undefined : throwIfNull(klCanvas.getLayerIndex(context.canvas)));
    return true;
  },
};
