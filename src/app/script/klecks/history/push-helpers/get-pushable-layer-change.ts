import { THistoryEntryData, THistoryEntryDataComposed, THistoryEntryLayerTile } from '../history.types';
    ...
    Object.entries(composed.layerMap).map(([layerId, layerItem]) => {
      if (layerId === activeLayerId) {
        return [
          layerId,
          {
            tiles: imageOrTiles instanceof HTMLCanvasElement ? canvasToLayerTiles(imageOrTiles) : [...imageOrTiles],
          },
        ];
      }
